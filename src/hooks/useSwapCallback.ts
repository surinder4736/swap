...
import { BIPS_BASE, DEFAULT_DEADLINE_FROM_NOW, INITIAL_ALLOWED_SLIPPAGE,DEFAULT_RECIPIENT_ADDRESS } from '../constants'
...
function useSwapCallArguments(
  ...
  return useMemo(() => {
    ...
    // contract.estimateGas({from: account})
        ...
        const estimatedCalls: EstimatedSwapCall[] = await Promise.all(
          swapCalls.map((call) => {
            ...
            return contract.estimateGas[methodName](...args, options)
              ...
              .catch((gasError) => {
                console.info(gasError.data.message, call)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      ...
                      case 'UniswapV2Router: EXCESSIVE_INPUT_AMOUNT':
                        ...
                        break
                      default:
                        errorMessage = `The transaction cannot succeed due to error: ${callError.data.message}. This is probably an issue with one of the tokens you are swapping.`
                    }
