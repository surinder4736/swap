...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@nguyenphu27/sdk'
...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xa3324013a5694e81a1787e4eee22f03350202abd')).toBe('0xa3324013a5694e81a1787e4eee22f03350202abd')
      expect(isAddress('0xa3324013a5694e81a1787e4eee22f03350202abd')).toBe('0xa3324013a5694e81a1787e4eee22f03350202abd')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0xa3324013a5694e81a1787e4eee22f03350202abd')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0xa3324013a5694e81a1787e4eee22f03350202abd')).toBe('0xf164...b92a')
    })
