describe.only('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    cy.visit('/add/0x8e57728e9B33597cf34CfA08317752cb367BFC7d/0xe9e7cea3dedca5984780bafc599bd69add087d56')
  ...
  it('does not crash if CAKE is duplicated', () => {
    cy.visit('/add/0x8e57728e9B33597cf34CfA08317752cb367BFC7d/0x8e57728e9B33597cf34CfA08317752cb367BFC7d')
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'CAKE')
